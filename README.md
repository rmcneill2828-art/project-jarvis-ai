...
| Current Phase | No session currently open. [[ESR-0053_ENGINEERING_SESSION_REPORT|ESR-0053]] closed (27 August 2026) / two Work Packages delivered: EBG-0106 Active Backlog View Generation (WP1), EBG-0125 Kokoro Production Voice Wiring - Guardian's live production speech provider is now Kokoro, replacing Piper (WP2), plus a Pass session-wide WP6 and a WP7 Establish determination (RBL-0033) |
...
| Current Engineering Focus | No session is currently open. [[ESR-0053_ENGINEERING_SESSION_REPORT|ESR-0053]] is the latest closed session, with [[RBL-0033_REPOSITORY_BASELINE|RBL-0033]] (established at ESR-0053 WP7) as the current repository baseline - Guardian's production speech-synthesis provider changed from Piper to Kokoro this session, a genuine live product-capability change. See [[PST-0001_PROGRAMME_STATUS|PST-0001]] for the current authoritative programme-state snapshot. |
...
- [[RBL-0033_REPOSITORY_BASELINE|RBL-0033]] is the current accepted repository baseline, established at ESR-0053 (Active Backlog View Generation; Kokoro Production Voice Wiring, a genuine live product-capability change).
...
- No session is currently open; [[ESR-0053_ENGINEERING_SESSION_REPORT|ESR-0053]] is the latest closed session.
