...
| Current Phase | No session currently open. [[ESR-0058_ENGINEERING_SESSION_REPORT|ESR-0058]] closed (16 September 2026) / six Work Packages delivered: Engineering Reviewer succession (WP1/WP2, GitHub Copilot CLI), BRD-0001 recovery (WP3), Home Assistant read-only agent (WP4), Playwright E2E reliability fix (WP5), Memory Management UXP surface (WP6), plus a genuine session-wide WP7 review (GitHub Copilot CLI, Conditional Pass) and a WP8 Establish determination (RBL-0038) |
...
| Current Engineering Focus | No session is currently open. [[ESR-0058_ENGINEERING_SESSION_REPORT|ESR-0058]] is the latest closed session, with [[RBL-0038_REPOSITORY_BASELINE|RBL-0038]] (established at ESR-0058 WP8) as the current repository baseline - GitHub Copilot CLI appointed as the new permanent Engineering Reviewer (resolving EBG-0126, ChatGPT/Codex's own retirement found at ESR-0057), BRD-0001's recovery capability delivered in full, a third specialist agent (Home Assistant read-only state-query), a genuinely root-caused and fixed Playwright parallel-worker reliability issue, and a Memory Management UXP surface completing BRD-0001's backup/recovery lifecycle. See [[PST-0001_PROGRAMME_STATUS|PST-0001]] for the current authoritative programme-state snapshot. |
...
- Memory and Data Storage Architecture specification ([[MDS-0001_MEMORY_AND_DATA_STORAGE_ARCHITECTURE|MDS-0001]]) approved; its Personal Memory tier is implemented (`jarvis/memory/`, a real consent-gated SQLite store, ESR-0027) and wired into live conversation via the Guardian Cognitive Core (ESR-0039). Backup, Recovery and Data Protection guidance ([[BRD-0001_BACKUP_RECOVERY_AND_DATA_PROTECTION_GUIDANCE|BRD-0001]], ESR-0057) defines expectations and delivers a first Personal Memory export/backup capability (`memory.backup` RPC method) - recovery/restore remains future work. Session and Shared-Family tiers remain not started.
...
- [[RBL-0038_REPOSITORY_BASELINE|RBL-0038]] is the current accepted repository baseline, established at ESR-0058 (Engineering Reviewer succession - GitHub Copilot CLI appointed, resolving EBG-0126; [[BRD-0001_BACKUP_RECOVERY_AND_DATA_PROTECTION_GUIDANCE|BRD-0001]] recovery capability; Home Assistant read-only agent; Playwright E2E reliability fix; Memory Management UXP surface). GitHub Copilot CLI, the new permanent Engineering Reviewer, was genuinely used for design and post-commit review at every Work Package this session, plus a full session-wide review.
...
- No session is currently open; [[ESR-0058_ENGINEERING_SESSION_REPORT|ESR-0058]] is the latest closed session.
...
| [[ESR-0058_ENGINEERING_SESSION_REPORT|ESR-0058]] | Latest closed engineering session (six Work Packages), opened at the Programme Sponsor's direct request to resolve EBG-0126. WP1/WP2 re-appointed GitHub Copilot CLI as the new permanent Engineering Reviewer, resolving EBG-0126; WP3 delivered [[BRD-0001_BACKUP_RECOVERY_AND_DATA_PROTECTION_GUIDANCE|BRD-0001]]'s recovery capability in full, completing EBG-0023; WP4 delivered the third specialist agent (`home-assistant-state-query`), resolving EBG-0127; WP5 root-caused and fixed a reproduced Playwright parallel-worker cold-start race, resolving EBG-0129; WP6 delivered a Memory Management UXP surface, resolving EBG-0131. A Programme Sponsor-requested GitHub Copilot CLI gap analysis registered EBG-0130/EBG-0132/EBG-0133/EBG-0134 (Candidate Backlog). **Session-wide WP7 was a genuine GitHub Copilot CLI review** - Conditional Pass, one real finding (EBG-0126's own register row) caught and fixed. WP8 Establish - RBL-0038 accepted. |
| [[ESR-0057_ENGINEERING_SESSION_REPORT|ESR-0057]] | Three Work Packages, opened at the Programme Sponsor's direct request following an instruction to read PBK-0001, no initial Work Package selection given. WP1 corrected 19 stale `EBG-####` references across [[JRM-0001_PROJECT_ROADMAP|JRM-0001]]; WP2 created [[BRD-0001_BACKUP_RECOVERY_AND_DATA_PROTECTION_GUIDANCE|BRD-0001]] (Draft, resolving EBG-0023) plus a real Personal Memory export/backup implementation slice; WP3 produced [[WR-ESR0057-001_HOME_ASSISTANT_SMART_HOME_INTEGRATION_ASSESSMENT|WR-ESR0057-001]] (Working Report), closing EBG-0025 and registering EBG-0127/EBG-0128. **Codex, the permanent Engineering Reviewer, was found retired on cost grounds mid-session** (not merely unavailable) - EBG-0126 registered; every Work Package from WP1 onward closed via Programme Sponsor direct review plus Engineering Implementer self-verification instead of genuine independent AI review. Session-wide WP6 self-verified - Pass, disclosed as materially weaker than the standing template. WP7 Establish - RBL-0037 accepted; retained for lineage, no longer the latest closed session or latest baseline; EBG-0126 resolved the following session. |
| [[ESR-0056_ENGINEERING_SESSION_REPORT|ESR-0056]] | Four Work Packages, opened at the Programme Sponsor's direct request following an instruction to read PBK-0001. WP1 closed EBG-0085 (esbuild/vite dev-server vulnerability upgrade); WP2 re-verified EBG-0058 (already Complete) and fixed JRM-0001 staleness; WP3 created [[DRA-0001_DEVICE_BOOTSTRAP_AND_RESTORE_ARCHITECTURE|DRA-0001]] (Draft), narrowing EBG-0046's scope to the genuine gap once MDS-0001's coverage was accounted for; WP4 fixed a second JRM-0001 staleness cluster (REG-0001 HST/FCH gap, already resolved since ESR-0028). Session-wide WP6 genuine background Codex review - Pass, no blocking findings. WP7 Establish - RBL-0036 accepted; retained for lineage, no longer the latest closed session or latest baseline. |
...
|---------|------------|-------------------------------|------------------------------------------------------------|
| 3.41 | 16 September 2026 | Claude Engineering Implementer | ESR-0058 formally closed. RBL-0038 established (Engineering Reviewer Succession - GitHub Copilot CLI appointed, resolving EBG-0126; BRD-0001 recovery; Home Assistant read-only agent; Playwright reliability fix; Memory Management UXP), superseding RBL-0037. GitHub Copilot CLI, the new permanent Engineering Reviewer, was genuinely used for design/post-commit review at every Work Package this session plus a full session-wide review - independent-AI-review coverage restored after ESR-0057's session-long gap. Top Project Status table, Personal Memory implementation bullets, Related Artefacts table (new ESR-0058 row, ESR-0057 row reworded to lineage-only) and "latest closed session"/"no session currently open" references updated. No governance artefact content changed beyond this session's own delivery; PST-0001 remains the authoritative source this README summarises. |
| 3.40 | 14 September 2026 | Claude Engineering Implementer | ESR-0057 formally closed. RBL-0037 established (JRM-0001 whole-document staleness sweep; BRD-0001 Personal Memory export/backup; Home Assistant assessment), superseding RBL-0036. Codex, the permanent Engineering Reviewer, found retired on cost grounds mid-session (EBG-0126 registered) - every Work Package from WP1 onward closed via Programme Sponsor direct review plus Engineering Implementer self-verification instead of genuine independent AI review. Top Project Status table, Personal Memory implementation bullets (both instances), Related Artefacts table (new ESR-0057 row, ESR-0056 row reworded to lineage-only) and "latest closed session"/"no session currently open" references updated. No governance artefact content changed beyond this session's own delivery; PST-0001 remains the authoritative source this README summarises. |
