...
| Current Phase | [[ESR-0050_ENGINEERING_SESSION_REPORT|ESR-0050]] open (5 August 2026) / three Work Packages delivered: PCB-0001/Capability Matrix content refresh (WP1), EBG-0120 Agent Framework UXP Wiring resolved (WP2), EBG-0047 Sentinel Gate of Durin Architecture Specification resolved (WP3), plus a Pass session-wide WP6 and a WP7 Establish determination |
...
| Current Engineering Focus | [[ESR-0050_ENGINEERING_SESSION_REPORT|ESR-0050]] is open (WP1-WP3 complete), with [[RBL-0031_REPOSITORY_BASELINE|RBL-0031]] established as the current repository baseline at WP7 (a genuine live product-capability change: Guardian's Agent Framework is now invokable live through the UXP, not just RPC/backend-reachable). See [[PST-0001_PROGRAMME_STATUS|PST-0001]] for the current authoritative programme-state snapshot. |
...
- [[RBL-0031_REPOSITORY_BASELINE|RBL-0031]] is the current accepted repository baseline, established at ESR-0050 (Agent Framework UXP Wiring; Sentinel Gate of Durin Architecture Specification, a genuine live product-capability change).
...
- [[ESR-0050_ENGINEERING_SESSION_REPORT|ESR-0050]] is currently open (WP1-WP3 complete, session-wide WP6 Pass, WP7 Establish); [[ESR-0049_ENGINEERING_SESSION_REPORT|ESR-0049]] is the latest closed session.
