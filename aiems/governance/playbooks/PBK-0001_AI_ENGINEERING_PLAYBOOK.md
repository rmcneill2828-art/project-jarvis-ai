...
* [[RBL-0036_REPOSITORY_BASELINE|RBL-0036]] records the current accepted repository baseline, established at ESR-0056 (esbuild/vite Security Upgrade; DRA-0001 Device Bootstrap and Restore Architecture). [[RBL-0009_REPOSITORY_BASELINE|RBL-0009]] is retained for historical baseline lineage only.
