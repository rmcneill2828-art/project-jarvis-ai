...
* [[RBL-0030_REPOSITORY_BASELINE|RBL-0030]] records the current accepted repository baseline, established at ESR-0049 (Agent Framework Phase 3, First Specialist Agent, a genuine live product-capability change). [[RBL-0009_REPOSITORY_BASELINE|RBL-0009]] is retained for historical baseline lineage only.
