...
* [[RBL-0028_REPOSITORY_BASELINE|RBL-0028]] records the current accepted repository baseline, established at ESR-0046 (User Identity and Profile Foundation, a genuine live product-capability change). [[RBL-0009_REPOSITORY_BASELINE|RBL-0009]] is retained for historical baseline lineage only.
