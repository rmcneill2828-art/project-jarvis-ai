...
Repository evidence records ADR-0004 as an approved governance decision dated 24 June 2026. REG-0002 describes its intent as defining governance, approval model and responsibilities for AI-assisted repository interaction. REG-0004 records ACT-0004 as completed for creating the AI Repository Interaction Policy. REG-0003 references ADR-0004 as mitigation for AI repository interaction exceeding approved governance.
...
- AI role boundaries must remain visible in operational artefacts such as COC-0001 and PBK-0001.
...
- REG-0002 row for ADR-0004: AI Repository Interaction Policy, Governance, Approved, 24 Jun 2026.
- REG-0003 RSK-0008 mitigation referencing AI Repository Interaction Policy (ADR-0004).
- REG-0004 ACT-0004 recording creation of AI Repository Interaction Policy as completed on 24 Jun 2026.
- ESR-0001 and ESR-0002 references to ADR-0004 recovery or formal supersession.
- EBR-0001 EBG-0001 approved backlog item for ADR-0004 recovery or formal supersession.
