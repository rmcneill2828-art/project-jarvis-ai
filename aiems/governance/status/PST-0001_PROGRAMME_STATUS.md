...
PST-0001 records ESR-0030 as the currently open session (WP2 delivered) and ESR-0029 as the latest closed session. It does not itself approve implementation outside separately authorised engineering work. Full historical detail remains in each session's own report and [[REG-0001_CONTROLLED_ARTEFACT_REGISTER|REG-0001]]'s version history.
