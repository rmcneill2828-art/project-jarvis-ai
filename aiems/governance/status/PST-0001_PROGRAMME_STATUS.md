...
| Next Work Package Candidate | Not yet determined - to be selected by the Programme Sponsor at the next engineering session's opening, informed by [[EBR-0001_ENGINEERING_BACKLOG_REGISTER|EBR-0001]]'s open High-priority items (including EBG-0098, EBG-0100 and EBG-0101, all registered at ESR-0031) and [[JRM-0001_PROJECT_ROADMAP|JRM-0001]]'s Near-term candidates. | Not decided by this status update. |
