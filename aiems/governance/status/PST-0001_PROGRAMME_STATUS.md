...
| Current Phase | ESR-0032 open, in progress (opened 21 July 2026); WP0/WP0B/WP1/WP2/WP3 complete - all Theme 1 items (EBG-0102/0103/0104) delivered; session-wide WP4 (Independent Repository Verification) and WP5 (Repository Baseline Acceptance) remain; under the permanent [[EE-0001_INDEPENDENT_AI_PEER_REVIEW_TRIAL|EE-0001]] Section 7 appointment (Claude Engineering Implementer, ChatGPT/Codex Engineering Reviewer, Programme Sponsor gating). |
