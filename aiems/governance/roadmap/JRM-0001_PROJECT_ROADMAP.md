...
| Item | Rationale |
|------|-----------|
| EBG-0058 - PBK-0001 Clause Consolidation | **Resolved at ESR-0028 WP1** per [[EIP-ESR0028-001_AIEMS_PROCESS_HYGIENE_BATCH|EIP-ESR0028-001]] Section 4.4 - the one genuine near-verbatim, zero-added-content restatement found (repository-operations-authorisation, three copies) was consolidated into PBK-0001 v1.28; three other named candidates reviewed and deliberately retained unmerged, each carrying genuine distinct content. **Re-verified at ESR-0056 WP2**: PBK-0001's growth since (v1.29-v1.43) checked against the same bar - no new duplication found. This row was stale (listed as open) until this correction. |
| REG-0001 HST/FCH registration gap | **Resolved at ESR-0028 WP1** - formally created and closed Complete as [[EBR-0001_ENGINEERING_BACKLOG_REGISTER|EBR-0001]] EBG-0071: 10 tracked artefacts (HST-0015/0016/0017/0020 and FCH-0020_GPT) diffed against REG-0001 and registered, Engineering Reviewer-confirmed complete. This row was stale (listed as open) until corrected at ESR-0056 WP4. |
| EBG-0005 - REG-0001 metadata alignment following P2-004A | Long-approved, low effort, closes a historical gap. **Resolved by Attrition at ESR-0028 WP1** per [[EIP-ESR0028-001_AIEMS_PROCESS_HYGIENE_BATCH|EIP-ESR0028-001]] Section 4.1 - REG-0001 found continuously, actively maintained with no identifiable P2-004A-era gap remaining; closing the item cost more to re-derive than it was worth, disclosed as attrition rather than a verified reconstruction. This row was stale (listed as open) until this correction, found during ESR-0057 WP1's whole-document staleness sweep. |
...
| EBG-0068 - Engineering Implementation Brief (EIB) artefact type, adopt or drop | Discovered at ESR-0021 WP6. Not a build item - a quick judgement call (confirm EIB was superseded by the EIP convention that followed it, mark Superseded, close). Cheapest possible win in this roadmap; no reason to leave it open. **Closed as Superseded at ESR-0028 WP1** per [[EIP-ESR0028-001_AIEMS_PROCESS_HYGIENE_BATCH|EIP-ESR0028-001]] Section 4.2 - no EIB-* artefact ever existed to retire; the EIP convention has been used exclusively since. This row was stale (listed as open) until this correction, found during ESR-0057 WP1's whole-document staleness sweep. |
...
| EBG-0009 - Engineering Session Standard | Same rationale as EBG-0008, for session lifecycle rather than EIP structure. **Closed Complete at ESR-0033 WP2** per Codex-led Theme 7 independent triage. This row was stale (listed as open Mid-term) until this correction, found during ESR-0057 WP1's whole-document staleness sweep. |
| EBG-0010 - Repository metadata / cross-reference validation rules | Natural precursor to EBG-0014 (validation automation) - sequence before it. **Closed Complete at ESR-0033 WP2** per Codex-led Theme 7 independent triage - rules landed across STD-0001's metadata/lifecycle/identifier provisions. EBG-0014 (Section 6.3) closed the same session. This row was stale (listed as open Mid-term) until this correction, found during ESR-0057 WP1's whole-document staleness sweep. |
| EBG-0013 - Engineering Decision Index | Growing ADR/decision count (20+ ADRs) makes this increasingly valuable; not urgent yet. **Closed Complete at ESR-0033 WP2** per Codex-led Theme 7 independent triage - REG-0002 (ADR Register) is the controlled searchable index this item asked for. This row was stale (listed as open Mid-term) until this correction, found during ESR-0057 WP1's whole-document staleness sweep. |
...
| Item | Rationale |
|------|-----------|
| EBG-0014 - Repository validation automation | Explicitly gated on EBG-0010 first; premature until that baseline exists. **Both EBG-0010 and EBG-0014 closed Complete at ESR-0033 WP2** per Codex-led Theme 7 independent triage - `scripts/validate_repository.py` exists, is tested, and is wired into repository discipline via PBK-0001 WP0A's pre-commit-hook check. This row was stale (listed as not-yet-justified) until this correction, found during ESR-0057 WP1's whole-document staleness sweep. |
...
| EBG-0032 - Historical Engineering Register | Nice-to-have; GDE-0001's knowledge tiering already substantially addresses the underlying need (bounded session-start review, Historical Archive on demand). **Closed Complete at ESR-0033 WP2** per Codex-led Theme 7 independent triage - the need is met by REG-0001's baseline lineage, PST-0001's completed-milestones record and GDE-0001's Historical Archive, without a separate register. This row was stale (listed as open) until this correction, found during ESR-0057 WP1's whole-document staleness sweep. |
| EBG-0033 - AIEMS Improvement Register | Candidate Backlog since ESR-0005, never picked up; EBR-0001 and Section 8 entries in EE-0001 have informally covered this need so far. **Closed Complete at ESR-0033 WP2** per Codex-led Theme 7 independent triage - AIEMS improvements are recorded and actioned through EBR-0001 itself, PBK-0001's version history, PST-0001's outstanding-observations sections and concrete improvement EIPs; the mechanism is distributed rather than one named register, but functioning and controlled. This row was stale (listed as open) until this correction, found during ESR-0057 WP1's whole-document staleness sweep. |
| EBG-0034, EBG-0035, EBG-0036, EBG-0037 - authority/context/verification/classification refinements | All Candidate Backlog since ESR-0005, all reasonable, none blocking current work. Batch for a future dedicated governance-hygiene session rather than one-at-a-time. **All four closed at ESR-0033 WP2** per Codex-led Theme 7 independent triage: EBG-0034/0035/0036 Complete (work-package authority boundaries, context activation guidance and WP6 verification expectations all found already governed by PBK-0001/COC-0001/STD-0004/GDE-0001); EBG-0037 Superseded (the EIP convention remains active; the proposed EAP/ECP classification scheme never became operative). This row was stale (listed as open, awaiting a future batch session) until this correction, found during ESR-0057 WP1's whole-document staleness sweep. |
| EBG-0038 - Formal AIEMS Standards Review | Explicitly about validating whether ESR-0006-era working practices (RFEP, RFDP, Continuous Repository Synchronisation, Engineering Ecosystem Synchronisation) deserve formal standard status. Reasonable but not urgent - these practices are functioning as working practices. **Closed Complete at ESR-0054 WP1** - a relevance check found no new formal standard warranted; the underlying need is already met organically by other artefacts. This row was stale (listed as open) until this correction, found during ESR-0057 WP1's whole-document staleness sweep. |
| EBG-0040, EBG-0043, EBG-0044 | Documentation/workflow-guidance items; useful, not blocking. **EBG-0043 and EBG-0044 closed Complete at ESR-0033 WP2** per Codex-led Theme 7 independent triage (ADR-0013 already records the Engineering Ecosystem Synchronisation and Obsidian/OSE validation workflows both items asked for); **EBG-0040 remains Approved Backlog**, still genuinely open. This row was stale (all three listed as open) until this correction, found during ESR-0057 WP1's whole-document staleness sweep. |
| EBG-0052 - Execute After Approval Principle | Candidate since ESR-0017. EBG-0058 (PBK-0001 Clause Consolidation) closed at ESR-0028 without touching this item - the "resolve together" framing was stale (corrected at ESR-0056 WP2); this item remains its own independent open candidate. |
...
| EBG-0062 - CPS-0001 Codex Prompt Standard | Discovered at ESR-0021 WP6. Lowest priority of the newly-discovered items per its own backlog note - 20+ sessions of established EIP convention have substantially met the original need even without a named standard. **Closed Superseded at ESR-0033 WP2** per Codex-led Theme 7 independent triage - duplicate of EBG-0008's EIP standard and TPL-0001's existing template; any remaining scope belongs to EBG-0008. This row was stale (listed as open) until this correction, found during ESR-0057 WP1's whole-document staleness sweep. |
| EBG-0064 - ISTL-0001 Engineering Inter-Session Task Register | Discovered at ESR-0021 WP6. Likely substantially satisfied already by PST-0001 Section 8 (Active and Next Planned Work) and EBR-0001 itself - action only if a real gap is confirmed, not by default. Overlaps EBG-0033 above. **Closed Complete at ESR-0033 WP2** per Codex-led Theme 7 independent triage - durable inter-session task tracking is handled by PST-0001's Active/Next Planned Work, EBR-0001, ESR handover sections and JRM-0001 sequencing; a separate register would add a tracking surface for a need already met. This row (and EBG-0033 above) were both stale (listed as open) until this correction, found during ESR-0057 WP1's whole-document staleness sweep. |
...
Phase 2 (EBG-0021) **delivered at ESR-0041 WP1**, moved to Section 7.2 below. No item currently occupies this slot - Phase 3 (Action faculty implementation) is the next item in the numbered dependency chain; **EBG-0128 registered at ESR-0057 WP3**, closing the gap this row previously flagged, though no implementation, policy change or specific action-capability selection is authorised by that registration (see Section 7.3 Phase 3).

## 7.2 Foundation (Delivered)

Not sequenced further - already landed and not revisited by this roadmap. Sentinel trust gateway with `TrustTierPolicy` wired into the production default (EBG-0074); a live provider wired into the default conversation route with local failover (EBG-0070, EBG-0075); Personal Memory, a real consent-gated SQLite tier (EBG-0080); GIA Phase 1, local resource/engineering-environment observability (EBG-0083 Phase 1 of 4); the UXP-backend bridge including streaming notifications (EBG-0050, EBG-0099); Guardian Desktop distribution, CI and release automation (EBG-0102/0103/0104, Theme 1 in full); GAM-0001's authority/HITL/family-safety model (EBG-0031/0020/0048); JARVIS Product Requirements/Capability Backlog and Cost Strategy/Framework work (EBG-0017, 0024, 0045, 0049, all Complete at ESR-0028 WP2/WP3); Guardian Cognitive Core, Phase 1 of Section 7.3 (EBG-0108, memory/history-informed reasoning loop, delivered at ESR-0039); Voice faculty, Phase 6 Increments A and B of Section 7.3 (EBG-0112, Sentinel-gated speech output, delivered at ESR-0040; speech input, delivered at ESR-0047); Local Agent Permission Boundary, Phase 2 of Section 7.3 (EBG-0021, GAM-0001 Section 8A policy definition, delivered at ESR-0041); User Identity and Profile Foundation (EBG-0116, local unauthenticated profile create/list/select against GAM-0001 Section 8.1's household roles, delivered at ESR-0046 - not itself a numbered Section 7.3 phase, but the prerequisite that made Phase 6 Increment B's gating design workable ahead of full role enforcement).
...
|-------|---------|-------------------|
| **1** | Guardian Cognitive Core | **Delivered at ESR-0039 WP1** (EBG-0108 Phase 1, per [[EIP-ESR0039-001_GUARDIAN_COGNITIVE_CORE_PHASE1_SCOPE|EIP-ESR0039-001]]) - Guardian now composes persona, retained Personal Memory and bounded conversation history before each provider call. Was the single most consequential gap in the whole roadmap; every phase below either extends it or depended on it existing. |
| **2** | EBG-0021 - Local Agent Permission Boundary | **Delivered at ESR-0041 WP1** (per [[EIP-ESR0041-001_LOCAL_AGENT_PERMISSION_BOUNDARY_SCOPE|EIP-ESR0041-001]]) - [[GAM-0001_GUARDIAN_AUTHORITY_AND_BOUNDARY_MODEL|GAM-0001]] Section 8A now defines the local-agent action boundary: a permanent ceiling that no such action may ever be Autonomous, illustrative permanently-out-of-scope versus conditionally-eligible action tiers, and Administrator-only future approval. Architecture/policy-definition only - no code changed, Sentinel's `LOCAL_AGENT_ACTION` classification remains `DENY`. |
| **3** | Action faculty (implementation) | **EBG-0128 registered at ESR-0057 WP3**, closing the "no backlog item yet" gap this row previously flagged - but registration does not itself authorise building the Action faculty, change Sentinel's `LOCAL_AGENT_ACTION` `DENY` default, or select a specific first capability (candidate: smart-home device control, surfaced by EBG-0025/[[WR-ESR0057-001_HOME_ASSISTANT_SMART_HOME_INTEGRATION_ASSESSMENT|WR-ESR0057-001]], not pre-selected). Depends on Phase 1 (something must decide what to act on, delivered) and Phase 2 (the constraint it must obey, delivered). STD-0006 (EBG-0065, see Section 7.4) should land before this phase ships, not after - already delivered. |
...
| **6** | Voice/Vision | **EBG-0112 registered at ESR-0039 closure** (unblocked once Phase 1 landed); **Increment A (speech output only) delivered at ESR-0040** per [[EIP-ESR0040-001_VOICE_PHASE6_INCREMENT_A_SPEECH_OUTPUT_SCOPE|EIP-ESR0040-001]] - `GuardianRuntime.speak()` synthesises Guardian's response text via a new Sentinel-gated, self-hosted Piper local-TTS provider (no API key, no recurring cost). **Increment B (speech input) delivered at ESR-0047** per [[EIP-ESR0047-001_VOICE_PHASE6_INCREMENT_B_SPEECH_INPUT_SCOPE|EIP-ESR0047-001]] - push-to-talk microphone capture via a self-hosted `faster-whisper` provider, Sentinel-gated, gated on real-time capability detection; made possible ahead of schedule by EBG-0116 (User Identity and Profile Foundation, delivered ESR-0046) closing enough of the GAM-0001 Section 8.1 Household Role Model concern that a deployment-level enablement gate (by analogy to Section 8.4) was judged sufficient for this increment, disclosed as such rather than claiming full role-authority enforcement. Vision (Increment C) remains not started, deliberately deferred - the same warrants-its-own-session judgement applied to Increment B originally still applies. EBG-0081 Question 1's shared animation scheduler (Section 7.4) remains available for this phase's future animated UI surfaces (e.g. a voice waveform) once a UXP increment adds one. |
...
| **8** | EBG-0025 - Home Assistant / Smart Home Integration Assessment | **Resolved at ESR-0057 WP3** per [[WR-ESR0057-001_HOME_ASSISTANT_SMART_HOME_INTEGRATION_ASSESSMENT|WR-ESR0057-001]]: Home Assistant identified as the right platform (only major ecosystem matching this project's self-hosted/no-cloud defaults), but device-control integration remains gated by Phase 3's `LOCAL_AGENT_ACTION` boundary regardless of platform choice, not by anything specific to this phase slot. EBG-0127 (a narrower, read-only state-query agent) registered separately - genuinely not gated on Phase 3 or Phase 4, unlike device control would be; see Section 7.5 Parallel. |
...
| Item | Rationale |
|------|-----------|
| EBG-0042 - Agent Framework Architecture | ADR-0011 exists; matures naturally once Phases 1-3 exist to define specialist agent contracts against. Left Candidate Backlog - not confidently ready before then. **Resolved at ESR-0048 WP2** per [[EIP-ESR0048-001_AGENT_FRAMEWORK_ARCHITECTURE_SCOPE|EIP-ESR0048-001]] - a new MOD-0001 "Agent Framework" subsection was created (architecture only), then built as real code with GIA wired as the first live specialist agent (ESR-0049/ESR-0050). This row was significantly stale (still described as "not confidently ready," Candidate Backlog) until this correction, found during ESR-0057 WP1's whole-document staleness sweep. |
...
| EBG-0047 - Sentinel Gate of Durin Architecture Specification | Extends EBG-0030 (Completed). Worth revisiting as trust-tier work (EBG-0074) sees further production use - left Candidate Backlog, not confidently satisfied by the current Sentinel Core implementation as of its last review. **Resolved at ESR-0050 WP3** per [[EIP-ESR0050-002_CURRENT_ARCHITECTURE_REFRESH_AND_GATE_OF_DURIN_DETAIL|EIP-ESR0050-002]] - `CURRENT_ARCHITECTURE.md` registered as a controlled artefact for the first time, with a new Sentinel Gate of Durin subsection. This row was stale (still described as "left Candidate Backlog, not confidently satisfied") until this correction, found during ESR-0057 WP1's whole-document staleness sweep. |
...
| EBG-0127 - Home Assistant Read-Only Smart-Home State Query Agent | Registered at ESR-0057 WP3, per [[WR-ESR0057-001_HOME_ASSISTANT_SMART_HOME_INTEGRATION_ASSESSMENT|WR-ESR0057-001]] Section 5. Mirrors the Agent Framework's existing GIA read-only observability precedent (`ROUTINE_INTERACTION`) - genuinely not gated on Phase 3's `LOCAL_AGENT_ACTION` boundary, unlike device-control work under Phase 8 would be. Candidate Backlog; action whenever there is an actual product need confirmed. |
...
2. **REG-0001 HST/FCH registration gap** (HST-0015 through HST-0020, FCH-0020_GPT missing from REG-0001's artefact table despite the files existing). Surfaced at ESR-0021 WP4 (EIP-ESR0021-002 Section 12), deferred to a Work Package at ESR-0021 closure per Programme Sponsor direction. **Resolved**: EBG-0071 was in fact created and closed Complete at ESR-0028 WP1 (corrected at ESR-0056 WP4, which found this line still phrased as an open recommendation).
...
|---------|------|--------|---------|
| 1.28 | 14 September 2026 | Claude Engineering Implementer | ESR-0057 WP3, per [[WR-ESR0057-001_HOME_ASSISTANT_SMART_HOME_INTEGRATION_ASSESSMENT|WR-ESR0057-001]]: Section 7.1/7.3 Phase 3's "no backlog item yet" gap closed - EBG-0128 registered. Section 7.3 Phase 8 (EBG-0025) marked Resolved - Home Assistant identified as the right platform, but device-control remains gated by Phase 3 regardless of platform. Section 7.5 Parallel gained EBG-0127 (read-only state-query agent, genuinely not gated on Phase 3/4). |
| 1.27 | 14 September 2026 | Claude Engineering Implementer | ESR-0057 WP1 (Documentation Debt Discipline) per [[EIP-ESR0057-001_JRM-0001_WHOLE_DOCUMENT_STALENESS_SWEEP|EIP-ESR0057-001]]: whole-document staleness sweep found 19 EBG references across Sections 6.1, 6.2, 6.3 and 7.5 describing items as open/pending that EBR-0001 shows already Complete, Superseded or Resolved by Attrition (most since ESR-0033 WP2's Codex-led Theme 7 triage, never reflected back into this roadmap) - each row corrected with a resolution annotation, no row deleted. Two rows were significantly stale rather than merely unannotated: EBG-0042 (Agent Framework Architecture) and EBG-0047 (Sentinel Gate of Durin Architecture Specification) were still described as open Candidate Backlog items in Section 7.5 despite both having been resolved with real delivered architecture work (ESR-0048 WP2, ESR-0050 WP3 respectively). Found via a cross-check of every EBG-#### reference in this document against EBR-0001's authoritative status, prompted by two initially-spotted stale rows (EBG-0005, EBG-0068) during ESR-0057 WP0A session-open review. |
| 1.26 | 4 September 2026 | Claude Engineering Implementer | ESR-0056 WP4 (Documentation Debt Discipline) per [[EIP-ESR0056-004_JRM-0001_REG-0001_HST-FCH_GAP_STALENESS_FIX|EIP-ESR0056-004]]: Section 6.1's "REG-0001 HST/FCH registration gap" line and Section 9's numbered item both corrected - EBG-0071 was in fact formally created and closed Complete at ESR-0028 WP1 (10 artefacts registered, Codex-confirmed), but both references still read as open work. Found via WP0B's own file-by-file cross-check of every HST/FCH artefact against REG-0001. |
| 1.25 | 4 September 2026 | Claude Engineering Implementer | ESR-0056 WP2 (Documentation Debt Discipline) per [[EIP-ESR0056-002_PBK-0001_ACCRETION_RECHECK_AND_JRM-0001_STALENESS_FIX|EIP-ESR0056-002]]: Section 6.1's EBG-0058 line corrected from "Already Approved Backlog... highest process-hygiene value of anything currently open" to reflect its actual Complete status (resolved ESR-0028 WP1, re-verified this session with no new PBK-0001 duplication found). Section 6.3's EBG-0052 line corrected to drop the stale "resolve together with EBG-0058" framing - EBG-0058 closed without touching EBG-0052, which remains its own independent open item. Found via WP0A candidate-list generation surfacing EBG-0058 as an open recommendation despite EBR-0001 already showing it Complete. |
| 1.24 | 4 August 2026 | Claude Engineering Implementer | ESR-0048 WP1 (Documentation Debt Discipline): Section 7.3 Phase 6 row corrected - Increment B (speech input) delivered at ESR-0047 per EIP-ESR0047-001, no longer "not started, deliberately deferred". Section 7.2 Foundation list extended with Increment B and EBG-0116 (User Identity, delivered ESR-0046, not itself a numbered phase but the prerequisite that made Increment B's gating design workable). Flagged stale (no entry since v1.23/ESR-0045 WP1, missing ESR-0045 WP4/WP5, ESR-0046 and ESR-0047 entirely) at ESR-0047 WP4's Repository Engineering Health Review. |
