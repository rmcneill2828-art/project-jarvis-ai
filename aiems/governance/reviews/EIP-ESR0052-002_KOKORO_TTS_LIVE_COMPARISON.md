...
| Version | 1.0 |
| Status | Approved - implemented; EBG-0115 closed Complete on the Programme Sponsor's positive listening verdict |
| Session | ESR-0052 |
| Work Package | WP3 |
...
* **No adoption decision made by this package**, per Section 4D. **Programme Sponsor Validation, verbatim**: "guardian-voice-kokoro-af_sarah.wav is much more natural and less robotic" than Piper - Kokoro preferred. The Programme Sponsor separately asked for a UK English voice, explicitly deferred ("something further down the line") - captured as new candidate item EBG-0125 in [[EBR-0001_ENGINEERING_BACKLOG_REGISTER|EBR-0001]] rather than actioned now. This verdict closes EBG-0115's own evaluation scope Complete; it does not itself make Kokoro Guardian's live production voice - `provider_config.py` wiring, RPC/UXP reachability and the UK-voice choice remain EBG-0125's separately-scoped follow-on work.
