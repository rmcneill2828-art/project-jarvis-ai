...
| EBG-0056 | PCB-0001 Product Capability Baseline Refresh | [[RBL-0013_REPOSITORY_BASELINE|RBL-0013]] Section 6 | Candidate Backlog | Medium | Programme Sponsor | [[PCB-0001_PRODUCT_CAPABILITY_BASELINE|PCB-0001]] (last updated 1 July 2026, before ESR-0007) is materially stale: Section 6 states "Guardian capability is not implemented" - false since ESR-0017 WP2 (Guardian&harr;Sentinel connected) and more visibly since WP9 (Guardian conversationally reachable through the real UXP, verified via a live windowed session); Section 4's "GUI" row describes only the Tkinter First Light interface, not the Tauri UXP that is now the live product surface. Flagged at [[RBL-0013_REPOSITORY_BASELINE|RBL-0013]] rather than silently carried forward as "unchanged." Refreshing PCB-0001 requires accurately characterising the entire current product capability set (not a one-line patch) and is Programme Sponsor-owned acceptance authority, per PCB-0001's own Section 8. No implementation is authorised by this backlog entry. |
