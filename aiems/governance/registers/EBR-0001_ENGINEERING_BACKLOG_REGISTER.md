...
| EBG-0056 | PCB-0001 Product Capability Baseline Refresh | [[RBL-0013_REPOSITORY_BASELINE|RBL-0013]] Section 6; drafted [[ESR-0020_ENGINEERING_SESSION_REPORT|ESR-0020]] WP4 | Drafted, In Review | Medium | Programme Sponsor | [[PCB-0001_PRODUCT_CAPABILITY_BASELINE|PCB-0001]] was materially stale (last updated 1 July 2026): Section 6 falsely stated "Guardian capability is not implemented" and Section 4 described only the Tkinter GUI, not the live Tauri UXP. **Refreshed to v2.0 at ESR-0020 WP4**, reflecting Sentinel/Guardian foundation, the live UXP-backend bridge, the Guardian Orb knowledge graph and both live-validated provider adapters. Reviewed by the Engineering Reviewer: no material overstatement found, refresh judged if anything conservative. **Non-blocking finding, not yet actioned**: some Section 4 wording still reads as an accepted-baseline snapshot while Status is In Review - acceptable for a versioned refresh, candidate for wording polish later if stricter consistency is wanted. PCB-0001 v2.0 Status remains **In Review** pending the Programme Sponsor's own acceptance decision (PCB-0001 Section 8 authority) - this backlog item closes once that acceptance is recorded. |
