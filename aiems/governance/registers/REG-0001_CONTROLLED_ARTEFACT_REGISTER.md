...
| REG-0001 | Register | Controlled Artefact Register | 3.24 | In Review | Programme Sponsor | CHR-0001 | `aiems/governance/registers/` |
...
| EBR-0001 | Register | Engineering Backlog Register | 1.10 | Draft | Programme Sponsor | CHR-0001 | `aiems/governance/registers/` |
...
| TPL-0001 | Template | Engineering Execution Package Template | 0.1 | Draft | Programme Sponsor & Chief Engineering Advisor | CHR-0002 | `aiems/templates/` |
...
| PBK-0001 | Playbook | AI Engineering Playbook | 1.10 | Draft | Programme Sponsor | CHR-0002 | `aiems/governance/playbooks/` |
...
| PST-0001 | Programme Status | Programme Status | 2.14 | Approved | Programme Sponsor | CHR-0001 | `aiems/governance/status/` |
